...
This sections provides a detailed overview of the validation and verification of the of the system. This includes specific roles in the process and plans for validating requirements from the Software Requirements Specification.
...
\begin{itemize}
  ...
  \item \textbf{Backend Server:} Testing of data, security and encryption, server capacity limits, and API responses. Testing framework(s) will depend on language used to build the backend. 
  \item \textbf{Database:} Verifying that database schema matches business logic, performance testing, and query correctness testing. Testing can be done through a database wrapper in Python with a test suite written with PyTest.
\end{itemize}
\textbf{System Level}
...
\subsubsection{Stakeholder Review}
  While regular weekly update meetings and/or feature demonstrations will occur with our supervisor, Luke Schermann, an additional formal stakeholder review will be conducted with Luke and any other MES executives who are interested in attending. A comprehensive walkthrough of the entire system will be presented, including a summary of key requirements and conduct end to end demonstrations of system workflows with a focus on the administrative user perspective. The purpose of the review is to confirm that the system meets all requirements specified by the stakeholders and provide an opportunity to gather feedback on the completed system to address any outstanding concerns before the final deployment.
\subsubsection{User Acceptance Testing}
  User acceptance testing will be conducted on a staging deployment of the system with a group of about 10 test users. Each user will be given a list of actions to perform on the attendee mobile application without help from developers, such as looking up and registering for an every or filling out a survey. The user will then provide feedback on the experience of completing these actions which will be analyzed for final improvments before the initial launch.

\subsubsection{Pilot Launch}
  By request of the project supervisor, a pilot program of the system will be launched in January. This pilot program will involve testing the system in a scenario with real users, such as the Fireball Formal and CFES National Survey. The system will be deployed to a production environment, where users will use the application as intended. Feedback will be collected by both attendees and admins to analyze and address any final problems before the official launch of the system. 
