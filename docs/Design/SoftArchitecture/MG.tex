...
\item [\refstepcounter{mnum}\mthemnum\label{m1}:] User Authentication Module

\item [\refstepcounter{mnum}\mthemnum\label{m2}:] User Authorization Module

\item [\refstepcounter{mnum}\mthemnum\label{m3}:] Form Template Module

\item [\refstepcounter{mnum}\mthemnum\label{m4}:] Form Submission Module

\item [\refstepcounter{mnum}\mthemnum\label{m5}:] Event Management Module

\item [\refstepcounter{mnum}\mthemnum\label{m6}:] Event Notification Module

\item [\refstepcounter{mnum}\mthemnum\label{m7}:] Registration Module

\item [\refstepcounter{mnum}\mthemnum\label{m8}:] Attendance Tracking Module

\item [\refstepcounter{mnum}\mthemnum\label{m9}:] Report Generation Module

\item [\refstepcounter{mnum}\mthemnum\label{m10}:] Analytics Module

\item [\refstepcounter{mnum}\mthemnum\label{m11}:] Database Access Module

\item [\refstepcounter{mnum}\mthemnum\label{m12}:] Audit Module
...
& \mref{m1}: User Authentication Module\\
& \mref{m2}: User Authorization Module\\
& \mref{m3}: Form Template Module\\
& \mref{m4}: Form Submission Module\\
& \mref{m5}: Event Management Module\\
& \mref{m6}: Event Notification Module\\
& \mref{m7}: Registration Module\\
& \mref{m8}: Attendance Tracking Module\\
& \mref{m9}: Report Generation Module\\
\midrule

\multirow{3}{0.3\textwidth}{Software-Decision Modules} 
& \mref{m10}: Analytics Module\\
& \mref{m11}: Database Access Module\\
& \mref{m12}: Audit Module\\
\bottomrule
...
\subsubsection{User Authentication Module (\mref{m1})}
...
\subsubsection{User Authorization Module (\mref{m2})}
\textbf{Secrets:} Rules defining access levels and user roles. Defines which features are to be accessed by each role.\\
\textbf{Services:} Provides the system with a ruleset on what each roles have access to.\\
\textbf{Implemented By:} Backend JavaScript API.\\
\textbf{Module Type:} Abstract Data Type Module.

\subsubsection{Form Template Module (\mref{m3})}
...
\subsubsection{Form Submission Module (\mref{m4})}
\textbf{Secrets:} Validation rules of the user input data.\\
\textbf{Services:} Receives and validates user-submitted forms and stores them in database.\\
\textbf{Implemented By:} Backend form processing JavaScript API.\\
\textbf{Module Type:} Abstract Object Module.

\subsubsection{Event Management Module (\mref{m5})}
...
\subsubsection{Event Notification Module (\mref{m6})}
...
\subsubsection{Registration Module (\mref{m7})}
\textbf{Secrets:} Mapping between users, events, and registration states.\\
\textbf{Services:} Allows users to register, modify, or cancel event participation. Provides validation and confirmation of registration within the event.\\
\textbf{Implemented By:} Backend JavaScript APIs.\\
\textbf{Module Type:} Abstract Data Type Module.

\subsubsection{Attendance Tracking Module (\mref{m8})}
...
\subsubsection{Report Generation Module (\mref{m9})}
...
\subsubsection{Analytics Module (\mref{m10})}
...
\subsubsection{Database Access Module (\mref{m11})}
...
\subsubsection{Audit Module (\mref{m12})}
...
\midrule
FR-1 & \mref{m3}, \mref{m4}\\
FR-2 & \mref{m9}, \mref{m10}\\
FR-3 & \mref{m7}, \mref{m5}\\
FR-4 & \mref{m7}\\
FR-5 & \mref{m5}\\
FR-6 & \mref{m11}\\
FR-7 & \mref{m11}, \mref{m3}, \mref{m4}\\
FR-8 & \mref{m9}, \mref{m10}\\
FR-9 & \mref{m3}, \mref{m4}\\
FR-10 & \mref{m5}\\
FR-11 & \mref{m2}\\
