...
\texttt{roles : map(string, set(T))}: Mapping of user to the set of roles the user is assigned.
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
\texttt{createEvent} & \texttt{eventDetails : EventData} & \texttt{eventId : $\mathbb{N}$} & IllegalArgument \\
\hline
