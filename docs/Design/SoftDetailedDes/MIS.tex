...
\begin{itemize}
  ...
  \item \texttt{confirmations : set(string)}: A set of all currently valid confirmation codes.
\end{itemize}
...
confirmation string is generated for a given \texttt{(userId, eventId)} touple, and the same QR Code is generated for a
