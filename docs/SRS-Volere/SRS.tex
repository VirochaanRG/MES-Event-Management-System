...
\begin{enumerate}[label=\bfseries AR-\arabic*:, wide=0pt, leftmargin=*]
  \item The interface shall comply with MES branding criteria (logo, imagse, colour scheme).\\[2mm]
...
\begin{enumerate}[label=\bfseries ER-\arabic*:, wide=0pt, leftmargin=*]
  \item Registration and feedback forms shall be intiutive and require no clarification.\\[2mm]
  ...
  \item Users shall sign-up/sign-in to the app with no instruction. \\[2mm]
    ...
    {\bf Goals:} G-2
  \item Admins shall interact with dashboard, create a custom form, and visualize analytics with minimal instruction.\\[2mm]
...
\begin{enumerate}[label=\bfseries LR-\arabic*:, wide=0pt, leftmargin=*]
...
\begin{enumerate}[label=\bfseries UR-\arabic*:, wide=0pt, leftmargin=*]
...
\begin{enumerate}[label=\bfseries AC-\arabic*:, wide=0pt, leftmargin=*]
  \item The app shall conform to WCAG 2.0 AA standards, improving visibility for impaired users.\\[2mm]
...
\begin{enumerate}[label=\bfseries SL-\arabic*:, wide=0pt, leftmargin=*]
  \item The system shall have a maximum 2-second latency for form loading, optimized for mobile devices.\\
  ...
  \item Attendee information and backend analytics shall have a maximum 4-second latency.\\
...
\begin{enumerate}[label=\bfseries FT-\arabic*:, wide=0pt, leftmargin=*]
  \item The system shall auto-save incomplete surveys every 30 seconds.\\
  ...
  \item The system shall locally queue changes and re-apply them after disconnects within 60 seconds.\\
  ...
  \item The system shall display a last updated signifier for all analytics.\\
...
\begin{enumerate}[label=\bfseries SE-\arabic*:, wide=0pt, leftmargin=*]
  \item The system shall be designed to allow for new analytic modules to be added in the future.\\
