...
2a. The submitted registration data has errors, the user application prompts the \gls{atd} to fix the errors and resubmit \\
4a. The event is full or the deadline has passed, the backend sends an error code to the user application \\
4b. The user application alerts the \gls{atd} of the error. \\
...
\end{enumerate}
\textbf{Sub variations:} \\
2a. The submitted data has errors (i.e. mandatory fields not filled), the user application prompts the \gls{atd} to fix the errors and resubmit \\
...
\end{enumerate}
\textbf{Sub variations:} \\
2a. The submitted form module has errors (i.e. unfinished fields), the \gls{adm} is prompted to fix these errors before resubmitting \\
4a. Authentication of the \gls{adm} fails, the admin portal is notified of the request denial \\
...
\end{enumerate}
\textbf{Sub variations:} \\
2a. The submitted details have errors (i.e. event date has already passed), the \gls{adm} is prompted to fix these errors before resubmitting \\
4a. Authentication of the \gls{adm} fails, the admin portal is notified of the request denial \\
...
\end{enumerate}
\textbf{Sub variations:} \\
3a. Authentication of the \gls{adm} fails, the admin portal is notified of the request denial \\
...
\setlength{\tabcolsep}{0.3em}
\renewcommand{\arraystretch}{1.2}
\begin{longtable}[H]{p{0.03\linewidth}p{0.22\linewidth}p{0.12\linewidth}p{0.43\linewidth}p{0.2\linewidth}}
\toprule
