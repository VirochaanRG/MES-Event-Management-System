...

{
  ...
  \begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|P{2.5em}|Y|Y|Y|Y|}
      ...
      1 & \Gls{atd} registers for event & Registration data & Event ticket & \ref{FR3}, \ref{FR4}, \ref{FR5} \\ \hline
      2 & \Gls{atd} fills out a survey & Survey responses & Survey completion confirmation & \ref{FR3}, \ref{FR4}, \ref{FR5}\\ \hline
