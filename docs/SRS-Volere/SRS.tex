...
actors. Figure X illustrates a work context diagram showing the interactions between the system components and external
elements.
...
\begin{enumerate}[align=left,
  ...
  \item The system shall store and handle all sensitive personal data in compliance with PIPEDA regulations.
\end{enumerate}
