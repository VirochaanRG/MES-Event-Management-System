...
\newline
This project aims to develop a solution which can centralize the activities of the MES within a single platform with functionality for both admins and users. We will be looking to address the current shortfalls and provide an upgrade upon the current implementation.
