...
\begin{enumerate}
    ...
    One part that we struggled with is the claddification of goals between stretch goals and goals as well as providing enough details to our goals. We didn't want to make it to detialed so it would be considered
