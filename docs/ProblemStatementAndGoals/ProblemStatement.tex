...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \textbf{Reasoning}: The current use of external tools or future use of custom modular builder ensures independence from third-party tools thus offering full customisation and no need for admin overhead in understanding th elogic of third-party tools.
    \end{itemize}
