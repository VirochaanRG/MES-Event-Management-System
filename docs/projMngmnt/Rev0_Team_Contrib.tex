...
Similar results to the POC Team Contribution report, with a couple members standing out from the rest. This is mainly due to them taking on management responsibilities, creating and assigning issues to team members, or recording team and supervisor meetings. As a result, the number of issues authored does not reflect the actual contributions.
\\\\
\noindent The assigned counts exhibit less of a discrepancy due to differing levels of detail when creating issues, with different members opting for different levels of granularity. All issues and task assignments were discussed in detail by the team collectively regardless of who authored or was assigned the issue. 
