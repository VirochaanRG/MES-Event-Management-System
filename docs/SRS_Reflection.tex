...
\begin{enumerate}
  \item \textbf{What went well while writing this deliverable?} \\
  While working on the deliverable we were able to coordinate well between members working on separate sections of the document. We found that after despite everyone working mostly individually, we were all generally on the same page in terms of goals, requirements, and use cases and we easily able to link them together into one cohesive document. 
