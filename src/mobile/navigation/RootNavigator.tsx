...
import { ModularSurveyScreen } from "../screens/user/ModularSurveyScreen";
...
function SurveysStackNavigator() {
  return (
    <SurveysStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <SurveysStack.Screen name="ModularSurvey" component={ModularSurveyScreen} />
      ...
      screenOptions={({ route }) => ({
        tabBarIcon: ({ focused, color, size }) => {
          ...
          switch (route.name) {
            ...
            case "Registered": iconName = focused ? "qr-code"     : "qr-code-outline";     break;
            case "Surveys":    iconName = focused ? "list"         : "list-outline";        break;
            case "Announcements": iconName = focused ? "megaphone" : "megaphone-outline";  break;
            case "AdminDashboard": iconName = focused ? "speedometer" : "speedometer-outline"; break;
            case "AdminEvents":    iconName = focused ? "calendar"    : "calendar-outline";    break;
            case "AdminAnalytics": iconName = focused ? "bar-chart"   : "bar-chart-outline";   break;
            case "AdminUsers":     iconName = focused ? "people"      : "people-outline";      break;
    ...
    >
      {isAdmin ? (
        <>
          ...
          <Tab.Screen name="AdminEvents"    component={AdminEventsScreen}    options={{ title: "Events" }} />
        ...
        <>
          ...
          <Tab.Screen name="Registered" component={RegisteredEventsScreen} options={{ title: "My Tickets", headerShown: false }} />
          <Tab.Screen name="Surveys"    component={SurveysStackNavigator} options={{ title: "Surveys", headerShown: false }} />
          <Tab.Screen name="Announcements" component={AnnouncementsScreen} options={{ title: "Updates", headerShown: false }} />
        </>
      )}
